...
var url = `${config.issuer}/oauth/v2/token?grant_type=authorization_code&code=${code}&client_id=${config.clientID}&client_secret=${config.clientSecret}&redirect_uri=${encodeURI(config.callbackURL)}&state=`;
